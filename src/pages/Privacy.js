    ...
    <main className="relative max-w-4xl mx-auto px-4 py-20 z-10 fade-in">
      <div className="glass-card p-8 md:p-12 max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-white/90">
          <p>
            Contact Tsunami, Inc., its subsidiaries and affiliates (collectively, "Contact Tsunami", or "we", "us", "our") respect the privacy and security of your personal data.
          </p>
          
          <p>
            This Privacy Policy describes how Contact Tsunami collects, uses, and shares your Personal Data when you visit our website, use our platform, or interact with us. This Privacy Policy also describes your rights and choices regarding your Personal Data. This Privacy Policy applies to individuals who visit Contact Tsunami, partner or client websites, and individuals who have a business relationship with Contact Tsunami, such as vendors and corporate sponsors, in their business interactions with Contact Tsunami. If you are a California resident, please review the "Notice of Collection for California" section below for important information about the categories of Personal Data we collect and disclose.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li><strong>Usage Information:</strong> Information about your computer, mobile device or other technology, when you visit Contact Tsunami, partner or client websites, including IP address, browser type, operating system, your responses to advertisements delivered by us, date and time, referring URLs and other information normally transmitted in HTTP requests.</li>
          ...
          <p>
            Contact Tsunami may use the information we obtain, license and collect about and from you for a number of business purposes, including, for example, to: better tailor our website and promotional content to your interests and preferences; provide you with information about our products and services; improve our products and services; and comply with legal obligations.
          </p>
          
          <h2 className="text-xl font-bold mb-4 text-white">Cookies and Similar Technologies</h2>
          
          <p>
            Contact Tsunami, and our publishing partners, Clients, affiliates, or analytics or service providers, use technologies such as cookies, beacons, tags, and scripts, to analyze trends, administer websites, track users' movements around websites, and to gather demographic information about our user base as a whole. When you access and interact with Contact Tsunami (as a representative of a business), Contact Tsunami and its service providers may collect certain information about those visits. We collect this information in the context of our business relationship with you, to allow you to explore the business research and intelligence services we provide.
          </p>
          
          <p>
            Contact Tsunami may use a variety of technologies, including "cookies" that automatically or passively collect information from your computer, mobile device or other technology, when you visit Contact Tsunami, partner or Client websites. We may also collect information in this way on a third party's behalf when we serve advertisements and store your Personal Data in log files.
          </p>
          
          <p>
            We may use this information to provide you with personalized content and advertisements, to analyze website usage, and to improve our services. We may also use this information to deliver targeted advertising content to each individual's interests. Contact Tsunami does not use this information to discern your identity or to disclose your identity to any third party. Contact Tsunami stores Personal Data in a separate database from any Usage Information.
          </p>
          
          <h2 className="text-xl font-bold mb-4 text-white">Opt-Out Options</h2>
          
          <p>
            If you opt-out of targeted advertising, Contact Tsunami will no longer use or disclose any of your Personal Data, with the exception of Personal Data submitted within the last 30 days to access free content, which the Content Provider may access.
          </p>
          
          <p>
            When you opt out of Contact Tsunami's Platform, we will place a special Contact Tsunami cookie on (or otherwise identify) your device or browser in a way that informs our systems not to record information related to your business research activities. If you browse the web from multiple devices, change browsers or delete the Contact Tsunami opt-out cookie (or clear all cookies), you will need to perform this opt-out task again.
          </p>
          
          <p>
            In instances where you visit a Client website through the Contact Tsunami Platform, the Client may use third-party vendors for the purposes of retargeting. We do not disclose Personal Data to these third parties, but they may set and access their own cookies, pixel tags, and similar technologies on your device, and they may collect or have access to information about you, including Usage Information.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Email: privacy@contact-tsunami.com</li>
            <li>Address: Data Privacy Officer, Contact Tsunami Inc., 123 Example St, New York, NY, 10001</li>
          </ul>
          
          <h2 className="text-xl font-bold mb-4 text-white">GDPR Compliance</h2>
          
          <p>
            If you are located in the European Economic Area (EEA) or the United Kingdom, you have additional rights under the General Data Protection Regulation (GDPR). You may contact our Data Protection Officer at privacy@contact-tsunami.com.
          </p>
          
          <p>
            If you are located in the EEA or the UK, you may contact our Article 27 local representative at eurep@contact-tsunami.com.
          </p>
          ...
          <p>
            Contact Tsunami takes precautions to protect all Personal Data and any other information under its control from misuse, loss or alteration. Contact Tsunami's security measures include industry-standard technology and equipment to help protect your information, and Contact Tsunami maintains security measures to allow only the appropriate personnel and contractors access to your information. Unfortunately, no system can ensure complete security, and Contact Tsunami disclaims any liability resulting from use of the Platform or from third-party hacking events or intrusions.
          </p>
          
          <h2 className="text-xl font-bold mb-4 text-white">Third-Party Links</h2>
          
          <p>
            Platform may contain links to or integrations with other sites that Contact Tsunami does not own or operate. This includes links from Clients and partners that may use the Contact Tsunami logo in a co-branding agreement, or websites and web services that we work with in order to provide the Platform. Contact Tsunami does not control, nor is Contact Tsunami responsible for, these sites or services or their content, products, services, privacy policies or practices. If you submit Personal Data on a web site using the Platform, you are choosing to disclose information to both Contact Tsunami and the third party with whose brand the website is associated. This Privacy Policy only governs Contact Tsunami's use of your Personal Data. A third party's use of your Personal Data is governed by the third party's privacy policy and practices, and not by this Privacy Policy.
          </p>
          
          <h2 className="text-xl font-bold mb-4 text-white">Children's Privacy</h2>
          
          <p>
            Contact Tsunami does not knowingly collect Personal Data or Usage Information from children under the age of 16 through its website or from any of our affiliates and partners. If you are under 16, please do not provide any Personal Data to us. If we learn that we have collected or received Personal Data from a child under 16, we will delete that information. If you believe we might have any information from or about a child under the age of 16, please contact us using one of the means provided in the "Contact Us" section below and we will seek to delete such Personal Data from our database.
          </p>
          
          <h2 className="text-xl font-bold mb-4 text-white">Changes to This Privacy Policy</h2>
          
          <p>
            We may update this Privacy Policy from time to time. The date of the most recent revision will appear at the top of this page. If we make material changes to this Privacy Policy, we will notify you by email or by posting a notice on our website. We encourage you to periodically revisit the Contact Tsunami Privacy Policy to see if it has been updated. We will always state the latest modification date of the Privacy Policy at the top of this page for your reference.
          </p>
          
          <h2 className="text-xl font-bold mb-4 text-white">Contact Tsunami Services</h2>
          
          <p>
            Contact Tsunami acts as a data processor in the provision of its services to its Clients ("Services") where it collects information under the direction of any one of its Clients, which may include Personal Data. In such cases, Contact Tsunami will only process Personal Data in accordance with the Client's instructions and applicable data protection laws. If you have questions about how your Personal Data is processed in connection with our Services, please contact the relevant Client directly.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>Phone: 9145236060</li>
            <li>Send an email to privacy@contact-tsunami.com</li>
            <li>Mail a letter to Data Privacy Officer, Contact Tsunami Inc., 123 Example St, New York, NY, 10001</li>
          </ul>
